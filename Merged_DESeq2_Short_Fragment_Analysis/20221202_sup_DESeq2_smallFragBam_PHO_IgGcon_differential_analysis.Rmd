---
title: "poolGenotypes DESeq2 sup smallFragmentBam PHO Analysis"
...
write.csv(as.data.frame(H3K36R.resOrdered), file = paste0("DESeq2_Results/",currentDate,"_K36R_HWT_sup_IgGcon_DESeq2_smallFragBam_PHO_results.csv")
                )
...
write.csv(as.data.frame(H33BK36R.resOrdered), file = paste0("DESeq2_Results/",currentDate,"_Adelta_H33BK36R_sup_IgGcon_DESeq2_smallFragBam_PHO_results.csv")
                )
