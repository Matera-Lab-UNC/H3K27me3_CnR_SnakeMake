---
title: "poolGenotypes DESeq2 sup smallFragmentBam SummitsPlusMinus150bp Analysis"
...
sample_id <- read.csv("sup_samples_IgGcon_DESeq2_smallFrag_sampleSheet.csv", header=T, stringsAsFactors = F)
...
# Subset your sample.id dataframe to only include individual replicates you want to put into DESeq
...
write.csv(as.data.frame(H3K36R.resOrdered), file = paste0("DESeq2_Results/",currentDate,"_K36R_HWT_sup_IgGcon_DESeq2_smallFragBam_SummitsPlusMinus150bp_results.csv")
                )
...
write.csv(as.data.frame(H33BK36R.resOrdered), file = paste0("DESeq2_Results/",currentDate,"_Adelta_H33BK36R_sup_IgGcon_DESeq2_smallFragBam_SummitsPlusMinus150bp_results.csv")
                )
