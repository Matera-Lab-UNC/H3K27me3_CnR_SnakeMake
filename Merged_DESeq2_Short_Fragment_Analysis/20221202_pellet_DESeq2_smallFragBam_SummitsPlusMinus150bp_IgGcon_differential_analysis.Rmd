---
title: "poolGenotypes DESeq2 pellet smallFragmentBam SummitsPlusMinus150bp Analysis"
...
write.csv(as.data.frame(H3K36R.resOrdered), file = paste0("DESeq2_Results/",currentDate,"_K36R_HWT_pellet_IgGcon_DESeq2_smallFragBam_SummitsPlusMinus150bp_results.csv")
                )
...
write.csv(as.data.frame(H33BK36R.resOrdered), file = paste0("DESeq2_Results/",currentDate,"_Adelta_H33BK36R_pellet_IgGcon_DESeq2_smallFragBam_SummitsPlusMinus150bp_results.csv")
                )
...
H3K36R.resOrdered %>%
  ...
  write.csv(., file = paste0("DESeq2_Results/",currentDate,"_K36R_HWT_pellet_IgGcon_DESeq2_smallFragBam_SummitsPlusMinus150bp_enrichment.csv")
                )
...
H33BK36R.resOrdered %>%
  ...
  dplyr::filter(log2FoldChange > 1 | log2FoldChange < -1) %>%
  dplyr::mutate(Enrichment = ifelse(log2FoldChange > 1, 'Up', 'Down')) %>%
  write.csv(., file = paste0("DESeq2_Results/",currentDate,"_Adelta_H33BK36R_pellet_IgGcon_DESeq2_smallFragBam_SummitsPlusMinus150bp_enrichment.csv")
                )
