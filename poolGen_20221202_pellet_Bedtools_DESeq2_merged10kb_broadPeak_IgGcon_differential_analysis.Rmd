---
title: "poolGenotypes Bedtools and DESeq2 Analysis Pellet Merged 10kb BroadPeak Analysis"
...
sample.id <- read.csv("Bedtools_DESeq2_broadPeak_Results/pellet_samples_IgGcon_Bedtools_DESeq2_merged10kb_broadPeak_sampleSheet.csv", header=T, stringsAsFactors = F)
...
write.csv(as.data.frame(annotation), 
          file = paste0("Bedtools_DESeq2_broadPeak_Results/pellet_featureCounts_annotation_",currentDate,".csv")
                )
...
write.csv(as.data.frame(H3K36R.resOrdered), file = paste0("Bedtools_DESeq2_broadPeak_Results/poolGen_",currentDate,"_K36R_HWT_pellet_IgGcon_DESeq2_merged10kb_broadPeak_results.csv")
                )
...
write.csv(as.data.frame(H33BK36R.resOrdered), file = paste0("Bedtools_DESeq2_broadPeak_Results/poolGen_",currentDate,"_Adelta_H33BK36R_pellet_IgGcon_DESeq2_merged10kb_broadPeak_results.csv")
                )
